...
function ToolsSettings({ isOpen, onClose }) {
  ...
  useEffect(() => {
    const handleStorageChange = (e) => {
      if (e.key === 'gemini-tools-settings' && isOpen) {
        loadSettings();
      }
    };
      ...
      <div className="bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
        <div className="flex items-center justify-between">
          ...
          <select
            ...
            className="text-sm bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100 rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2 w-48"
          >
            <option value="default">Classic (CLI)</option>
            <option value="gemini">Google Gemini</option>
            <option value="apple">Apple Liquid Glass</option>
          </select>
        </div>
      </div>
    </div>
